...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('public/app-assets/images/ico/atp_icon.png')}}">
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-none d-md-block"><a href="https://www.atptour.com/en/">atptour.com</a></span><span class="float-md-right d-none d-md-block">© Copyright 1994 - 2024 ATP Tour, Inc.</span></p>
    </footer>
    ...
    <script src="{{asset('public/app-assets/js/core/libraries/bootstrap.min.js')}}"></script>
